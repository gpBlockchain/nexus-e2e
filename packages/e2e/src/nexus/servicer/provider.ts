...
export async function ownershipSignData(page: Page, ownerShipType: OwnerShipType, signDataPayload: SignDataPayload): Promise<string> {
...
export async function enableWallet(page: Page) {
...
export async function getWalletIsEnable(page: Page) {
    return await page.evaluate(() => {
        // @ts-ignore
...
export async function getCkbVersion(page: Page) {
    return await page.evaluate(() => {
        // @ts-ignore
...
//todo
export async function ownershipGetOffChainLocks(page: Page, ownerShipType: OwnerShipType, payload: GetOffChainLocksPayload) {
...
export async function ownershipGetOnChainLocks(page: Page, ownerShipType: OwnerShipType, payload: GetOnChainLocksPayload) {
    const obj = {type: ownerShipType, payload: payload}
    return await page.evaluate((obj) => {
        // @ts-ignore
...
export async function ownershipGetLiveCells(page: Page, ownerShipType: OwnerShipType, payload?: GetLiveCellsPayload) {
    const obj = {type: ownerShipType, payload: payload}
    return await page.evaluate((obj) => {
        // @ts-ignore
